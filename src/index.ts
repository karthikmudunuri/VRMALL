...
async function setupViewer(){
    ...
    await manager.addFromPath("./assets/wou.glb")

    const drillMaterial = manager.materials!.findMaterialsByName('Rib_1X1_486gsm_FRONT_2246101')[0] as MeshBasicMaterial2
    ...
    function setupScrollanimation(){
        ...
        tl
        .to(position, {x: isMobile ? -6.0 : -5.6, y: isMobile ?  5.5 :  0.17, z: isMobile ? -3.3 :  -4.05,
            scrollTrigger: {
                trigger: ".second",
                start:"top bottom",
        ...
        .to(target, {x: isMobile ? -1.1 : -1.90, y: isMobile ? 1.0 : 0.15 , z: isMobile ? -0.1 : -0.28,
            scrollTrigger: {
                trigger: ".second",
                start:"top bottom",
                end: "top top", scrub: true,
        ...
        .to(position, {x: -3.15, y: -0.17, z: -0.12,
            scrollTrigger: {
                trigger: ".third",
                start:"top bottom",
                end: "top top", scrub: true,
        ...
        .to(target, {x: -1.89, y: -0.04 , z: -0.07,
            scrollTrigger: {
                trigger: ".third",
                start:"top bottom",
                end: "top top", scrub: true,
	...
	document.querySelector('.button--customize')?.addEventListener('click', () => {
        ...
        gsap.to(position, {x: -2.24, y: -0.06, z: -0.18, duration: 2, ease: "power3.inOut", onUpdate})
        gsap.to(target, {x: -1.89, y: -0.04 , z: -0.18, duration: 2, ease: "power3.inOut", onUpdate, onComplete: enableControlers})
	})
	...
	exitButton.addEventListener('click', () => {
        gsap.to(position, {x: -4.60, y: 0.11, z: 2.85, duration: 1, ease: "power3.inOut", onUpdate})
        gsap.to(target, {x: -0.89, y: 0.28 , z: -0.89, duration: 1, ease: "power3.inOut", onUpdate})
